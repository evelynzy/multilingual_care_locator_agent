...
SCENARIOS: tuple[Scenario, ...] = (
    Scenario("Clear Specialist Intent", "cardiovascular disease 98101", ("cardiovascular disease 98101",), "resolves to cardiology, not PCP"),
    Scenario("Clear Specialist Intent", "heart doctor near 98101", ("heart doctor near 98101",), "resolves to cardiology"),
    ...
    Scenario("Clear Specialist Intent", "obgyn 98101", ("obgyn 98101",), "resolves to OB/GYN"),
    Scenario("Clear Specialist Intent", "women's health doctor 98101", ("women's health doctor 98101",), "leans OB/GYN only if mapping is clear; otherwise asks"),
    ...
    Scenario("Layperson / Condition Phrasing", "heart problems 98101", ("heart problems 98101",), "likely cardiology or clarification"),
    Scenario("Layperson / Condition Phrasing", "irregular heartbeat near me", ("irregular heartbeat near me", "98101"), "preserves cardiology intent after location follow-up if needed"),
    ...
    Scenario("Ambiguity Should Trigger Follow-Up", "pain 98101", ("pain 98101",), "follow-up, not broad misleading search"),
    Scenario("Ambiguity Should Trigger Follow-Up", "mental health 98101", ("mental health 98101",), "does not auto-resolve to psychiatry; clarifies"),
    ...
    Scenario("Ambiguity Should Trigger Follow-Up", "therapy 98101", ("therapy 98101",), "clarifies; does not silently convert to psychiatry or PT"),
    Scenario("Ambiguity Should Trigger Follow-Up", "specialist near me", ("specialist near me", "98101"), "asks which specialty; follow-up ZIP path included"),
    Scenario("Ambiguity Should Trigger Follow-Up", "doctor for my child and allergies 98101", ("doctor for my child and allergies 98101",), "clarifies if family is unclear"),
    Scenario("Fallback Must Not Erase Specialist Intent", "cardiology 98101", ("cardiology 98101",), "fallback stays cardiology-oriented"),
    Scenario("Fallback Must Not Erase Specialist Intent", "obstetrics gynecology 98101", ("obstetrics gynecology 98101",), "fallback does not downgrade to PCP"),
    Scenario("Fallback Must Not Erase Specialist Intent", "ent 98101", ("ent 98101",), "fallback does not collapse to generic directory behavior"),
    Scenario("Fallback Must Not Erase Specialist Intent", "pediatrics 98101", ("pediatrics 98101",), "retry/fallback preserves pediatrics"),
    Scenario("Provider-Side Taxonomy / Variant Survival", "obstetrics gynecology 98101 (provider-side)", ("obstetrics gynecology 98101",), "valid OB/GYN providers survive taxonomy variants"),
    Scenario("Provider-Side Taxonomy / Variant Survival", "cardiology 98101 (provider-side)", ("cardiology 98101",), "cardiology subtype/provider_type variants survive"),
    Scenario("Provider-Side Taxonomy / Variant Survival", "ear nose throat 98101", ("ear nose throat 98101",), "provider taxonomy/label variants still match ENT family"),
    Scenario("Negative Boundary Cases", "urgent care 98101", ("urgent care 98101",), "care setting, not specialist-family rescue"),
    Scenario("Negative Boundary Cases", "imaging 98101", ("imaging 98101",), "does not over-infer specialty unless clearly supported"),
    Scenario("Negative Boundary Cases", "gi 98101", ("gi 98101",), "asks rather than over-guesses if too ambiguous"),
    Scenario("Negative Boundary Cases", "allergy 98101", ("allergy 98101",), "resolves only if query-safe mapping clearly supports it"),
    Scenario("Broad Specialist Browse Reference", "附近专科医生 -> 98101", ("附近专科医生", "98101"), "current browse-style behavior reference case"),
)
