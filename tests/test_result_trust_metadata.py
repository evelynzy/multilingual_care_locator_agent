...
class CareLocatorAgentResultTrustMetadataTests(unittest.TestCase):
    ...
    def test_handle_request_normalizes_local_provider_trust_metadata(self) -> None:
        ...
        self.assertIn('<span class="provider-card__badge">Informational match</span>', result)
        self.assertIn('<span class="provider-card__badge">Insurance/network not verified</span>', result)
        self.assertIn('<span class="provider-card__badge">Accepting new patients not verified</span>', result)
        self.assertIn('<span class="provider-card__badge">Appointment availability not verified</span>', result)
