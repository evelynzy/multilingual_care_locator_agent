...
class CareLocatorAgentProviderSearchRuntimeTests(unittest.TestCase):
            ...
            [
                {
                    "content": (
                        ...
                        '"summary":"ob gyn 95051","medical_need":true,"location":"95051",'
    ...
    def test_handle_request_emits_scoped_candidate_dump_when_fingerprint_matches(self) -> None:
        ...
        self.assertNotIn("95051", joined_logs)
    ...
    def test_handle_request_restores_zip_from_raw_message_when_valid_interpret_json_omits_location(self) -> None:
        ...
        client = _ScriptedChatClient(
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English","summary":"ob gyn 95051",'
    ...
    def test_handle_request_raw_message_without_explicit_cpt_strips_invented_procedure_gloss_from_query_payload(
        ...
        self.assertEqual(query_payload["summary"], "ob gyn 95051")
        self.assertEqual(query_payload["location"], "95051")
            ...
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English",'
                        '"summary":"cardiovascular disease 95051","medical_need":true,"location":null,'
    ...
    def test_handle_request_restores_primary_care_from_valid_interpret_json_with_empty_specialties(
        ...
        client = _ScriptedChatClient(
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English","summary":"primary care 15213",'
                        '"medical_need":true,"location":null,"specialties":[],"insurance":[],'
                        '"preferred_languages":[],"keywords":[],"patient_context":null,'
                        '"care_setting":null,"urgency":null,"needs_clarification":false,'
                        '"follow_up_focus":[]}'
        ...
        self.assertEqual(provider_request.location, "15213")
            ...
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English",'
                        '"summary":"cardiovascular symptoms 95051","medical_need":true,"location":null,'
                        '"specialties":[],"insurance":[],"preferred_languages":[],"keywords":[],'
                        '"patient_context":null,"care_setting":null,"urgency":null,'
                        '"needs_clarification":false,"follow_up_focus":[]}'
                    ),
    ...
    def test_handle_request_abstains_for_primary_care_or_cardiology_with_empty_valid_json_specialties(
            ...
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English",'
                        '"summary":"primary care or cardiology 95051","medical_need":true,'
                        '"location":"95051","specialties":[],"insurance":[],"preferred_languages":[],'
                        '"keywords":[],"patient_context":null,"care_setting":null,"urgency":null,'
                        '"needs_clarification":false,"follow_up_focus":[]}'
                    ),
                    "finish_reason": "stop",
        ...
        result = agent.handle_request(
            client,
            "primary care or cardiology 95051",
            [],
            max_tokens=256,
            temperature=0.2,
            top_p=0.9,
            ...
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English",'
                        '"summary":"child allergy 95051","medical_need":true,'
                        '"location":"95051","specialties":["Pediatrics"],"insurance":[],'
                        '"preferred_languages":[],"keywords":[],"patient_context":null,'
                        '"care_setting":"specialist","urgency":null,"needs_clarification":false,'
                        '"follow_up_focus":[]}'
                    ),
    ...
    def test_merge_parsed_queries_does_not_preserve_full_summary_for_location_only_follow_up_without_prior_specialty_clarification(
        ...
        self.assertEqual(merged_query.summary, "95051")
    ...
    def test_handle_request_explicit_cpt_preserves_trusted_city_state_zip_location(self) -> None:
        ...
        client = _ScriptedChatClient(
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English","summary":"CPT 95051 ob gyn Austin TX 78701",'
    ...
    def test_handle_request_explicit_cpt_does_not_promote_trailing_procedure_code_to_zip_after_city_state(
        ...
        client = _ScriptedChatClient(
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English","summary":"Austin TX CPT 95051 ob gyn",'
                        '"medical_need":true,"location":"Austin, TX","specialties":["OB/GYN"],"insurance":[],'
                        '"preferred_languages":[],"keywords":["cpt"],"patient_context":null,'
                        '"care_setting":"specialist","urgency":null,"needs_clarification":false,'
                        '"follow_up_focus":["procedure code"]}'
        ...
        provider_request = service.search.call_args[0][0]
        self.assertEqual(provider_request.location, "Austin, TX")
        self.assertNotEqual(provider_request.location, "Austin, TX 95051")
        self.assertIn("Austin OB/GYN Clinic", result)
    ...
    def test_handle_request_explicit_cpt_rejects_model_invented_city_without_raw_location_evidence(
        ...
        client = _ScriptedChatClient(
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English","summary":"CPT 95051 ob gyn Austin TX",'
                        '"medical_need":true,"location":"Austin, TX","specialties":["OB/GYN"],"insurance":[],'
                        '"preferred_languages":[],"keywords":["cpt"],"patient_context":null,'
                        '"care_setting":"specialist","urgency":null,"needs_clarification":false,'
                        '"follow_up_focus":["procedure code"]}'
    ...
    def test_handle_request_cardiology_95051_prefers_direct_specialty_result_over_generic_family_match(
        self,
    ) -> None:
    ...
    def test_handle_request_obgyn_95051_accepts_live_taxonomy_desc_payload_without_fallback(self) -> None:
        response = Mock()
    ...
    def test_handle_request_obgyn_95051_accepts_live_v3_rows_payload_without_fallback(self) -> None:
        response = Mock()
        response.status_code = 200
        response.json.return_value = [
            1,
    ...
    def test_handle_request_obgyn_95051_keeps_candidate_with_generic_provider_type_and_obgyn_taxonomy(
        self,
    ) -> None:
        response = Mock()
        response.status_code = 200
    ...
    def test_handle_request_obgyn_95051_keeps_candidate_with_physician_prefixed_live_taxonomy_variant(
        self,
    ) -> None:
        response = Mock()
        response.status_code = 200
    ...
    def test_handle_request_obgyn_95051_accepts_code_only_obgyn_payload_without_fallback(self) -> None:
        response = Mock()
        response.status_code = 200
        response.json.return_value = [
            1,
    ...
    def test_handle_request_obgyn_95051_uses_demo_broad_recall_variant_after_precise_requests(
        self,
    ) -> None:
        empty_response = Mock()
        ...
        self.assertEqual(request_params[0]["q"], "addr_practice.zip:95051*")
        self.assertIn("sf", request_params[0])
        self.assertEqual(request_params[1]["terms"], "obstetrics gynecology")
        self.assertEqual(request_params[1]["q"], "addr_practice.zip:95051*")
        self.assertIn("sf", request_params[1])
        self.assertEqual(request_params[2]["terms"], "obstetrics gynecology")
        self.assertEqual(request_params[2]["q"], "addr_practice.zip:95051*")
        self.assertIn("sf", request_params[2])
        self.assertEqual(request_params[3]["terms"], "ob gyn 95051")
    ...
    def test_handle_request_obgyn_95051_does_not_stop_on_unrelated_specialty_bearing_first_hit(
        self,
    ) -> None:
    ...
    def test_handle_request_pain_95051_uses_deterministic_clarification_response(
        self,
    ) -> None:
        service = Mock()
        service.search.return_value = ProviderSearchResponse(
        ...
        client = _ScriptedChatClient(
            [
                {
                    "content": (
                        '{"detected_language":"English","response_language":"English","summary":"pain 95051",'
                        '"medical_need":true,"location":"95051","specialties":[],"insurance":[],'
                        '"preferred_languages":[],"keywords":[],"patient_context":null,'
                        '"care_setting":null,"urgency":null,"needs_clarification":false,'
                        '"follow_up_focus":[]}'
                    ),
                ...
                {
                    "content": "This looks like CPT 95051 procedure code support.",
                    "finish_reason": "stop",
                },
            ]
        )
        ...
        self.assertNotIn("CPT 95051", result)
