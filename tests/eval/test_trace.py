...
class TraceSerializationTests(unittest.TestCase):
    ...
    def test_cache_path_is_stable_and_language_specific(self):
        with tempfile.TemporaryDirectory() as d:
            p_en = _cache_path(d, "s01-cardiology", "en", ("cardiology 95051",), "model-a")
            p_en2 = _cache_path(d, "s01-cardiology", "en", ("cardiology 95051",), "model-a")
            p_zh = _cache_path(d, "s01-cardiology", "zh", ("cardiology 95051",), "model-a")
            self.assertEqual(p_en, p_en2)
            self.assertNotEqual(p_en, p_zh)
            p_model_a = _cache_path(d, "s01-cardiology", "en", ("cardiology 95051",), "model-a")
            p_model_b = _cache_path(d, "s01-cardiology", "en", ("cardiology 95051",), "model-b")
...
class TraceCaptureAndCacheTests(unittest.TestCase):
    def test_capture_no_search_turn(self):
        ...
        turn = _capture_turn("mental health 95051", agent, "Could you clarify?")
    ...
    def test_capture_search_turn(self):
        ...
        turn = _capture_turn("cardiology 95051", agent, "<div class='provider-card'>")
        self.assertTrue(turn.searched)
