...
class CareLocatorAgentFollowUpStateTests(unittest.TestCase):
    ...
    def test_child_allergy_ambiguity_resolved_in_later_turn_uses_pediatrics(
        ...
        turn1_query = ParsedCareQuery(
            ...
            summary="doctor for my child and allergies 95051",
            medical_need=True,
            location="95051",
            specialties=[],
            insurance=[],
        ...
        turn2_full = ParsedCareQuery(
            detected_language="English",
            response_language="English",
            summary="child and allergies pediatrics 95051",
            medical_need=True,
            location="95051",
            specialties=[],
            insurance=[],
        ...
        with patch.object(
            ...
            turn1_result = agent.handle_request(
                client,
                "doctor for my child and allergies 95051",
                [],
                max_tokens=256,
                temperature=0.2,
                top_p=0.9,
            ...
            history = [
                {
                    "role": "user",
                    "content": "doctor for my child and allergies 95051",
                },
    ...
    def test_intent_switch_drops_stale_specialty(self) -> None:
        ...
        turn2_full = ParsedCareQuery(
            detected_language="English",
            response_language="English",
            summary="cardiology dermatologist 95051",
            medical_need=True,
            location="95051",
            specialties=["Cardiology"],
            insurance=[],
        ...
        turn2_latest = ParsedCareQuery(
            detected_language="English",
            response_language="English",
            summary="actually I need a dermatologist in 95051",
            medical_need=True,
            location="95051",
            specialties=["Dermatology"],
            insurance=[],
        ...
        with patch.object(
            ...
            turn2_result = agent.handle_request(
                client,
                "actually I need a dermatologist in 95051",
                history,
                max_tokens=256,
                temperature=0.2,
                top_p=0.9,
