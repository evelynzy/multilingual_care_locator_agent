...
class ProviderSearchServiceTests(unittest.TestCase):
    ...
    def test_search_zip_only_obgyn_95051_accepts_live_taxonomy_desc_payload_without_gate_changes(self) -> None:
        response = Mock()
    ...
    def test_search_zip_only_obgyn_95051_accepts_live_v3_rows_payload_without_broad_retry(
        self,
    ) -> None:
        response = Mock()
        response.status_code = 200
    ...
    def test_search_zip_only_obgyn_95051_admits_generic_provider_type_when_taxonomy_evidence_is_specific(
        self,
    ) -> None:
        response = Mock()
        response.status_code = 200
    ...
    def test_search_zip_only_obgyn_95051_admits_physician_prefixed_live_taxonomy_variant(
        self,
    ) -> None:
        response = Mock()
        response.status_code = 200
    ...
    def test_search_zip_only_obgyn_95051_prefers_direct_specialty_evidence_over_generic_family_match(
        self,
    ) -> None:
        generic_family_match = build_canonical_provider(
    ...
    def test_search_cardiology_95051_admits_live_cardiology_taxonomy_variant(
        self,
    ) -> None:
    ...
    def test_search_emits_scoped_clinicaltables_request_log_when_fingerprint_matches(self) -> None:
        ...
        self.assertIn("q=addr_practice.zip:95051*", joined_logs)
        self.assertIn(
    ...
    def test_search_zip_only_obgyn_95051_continues_to_canonical_variant_after_single_noisy_idv_hit(self) -> None:
        noisy_zip_providers = [
    ...
    def test_search_zip_only_obgyn_95051_uses_canonical_zip_variant_when_non_location_variant_stays_low_signal(
        self,
    ) -> None:
        noisy_zip_providers = [
            build_canonical_provider(
